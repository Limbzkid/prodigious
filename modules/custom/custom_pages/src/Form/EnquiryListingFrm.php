<?php
  ...
  /**
    * @file
    * Contains \Drupal\custom_pages\Form\EnquiryListingFrm.
    */
  ...
  class EnquiryListingFrm extends FormBase {
    ...
    public function contactCallback(array &$form, FormStateInterface $form_state) {
      ...
      if($error != '') {
        ...
        if($num_rows > 0) {
          ...
          $download = '<a href="'.$base_url.'admin/contact-data/enquiry/download?frm='.$from.'&to='.$to.'">Download</a>';
