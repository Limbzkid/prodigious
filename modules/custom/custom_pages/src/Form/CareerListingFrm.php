<?php
  ...
  /**
    * @file
    * Contains \Drupal\custom_pages\Form\CareerListingFrm.
    */
  ...
  class CareerListingFrm extends FormBase {

    /**
    * {@inheritdoc}
    */
    public function getFormId() {
      return 'career-listing';
    }
    ...
    public function contactCallback(array &$form, FormStateInterface $form_state) {
      ...
      if($error != '') {
        ...
        if($num_rows > 0) {
          ...
          $download = '<a href="'.$base_url.'admin/contact-data/career/download?frm='.$from.'&to='.$to.'">Download</a>';
